...
(** The signature of the ShipClasses type module *)
   module type ShipClasses = sig
      ...
      (** [get_length ship] Requires: Input ship representation. Returns: number of
        positions that the ship takes up.*)
      ...
      (** [hit_ship ship x y] Requires: Input ship representation. Coordinates x and
          ...
          Returns: the updated heatlh of the ship (decreased by 1 for 1 hit) *)
    ...
    (** Module that has contains the information of a ship and has functions
        to affect/check the health of ship as well as to see if a ship has sunk.  *)
