...
print_endline ("Each player will place their ships on there battle ground grids.");
...
(* print_endline ("Each player will place 5 ships: 1 Carrier ship 1 BattleShip 1 Destoryer 1 Submarine 1 PatrolBoat");
print_endline (player_1_name ^" you will place your ships first!");
print_endline (player_1_name ^" enter the coordiante of where you would like to the head of your carrier ship to be:");
let carrier_head = read_line() in 
  ...
  let tail_pos = BattleGround.ship_positons p1Carrier x1 y1 in
